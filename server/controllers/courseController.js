...
module.exports.postCourse__controller = async (req, res, next) => {
  try {
    ...
    const { courseDescription, courseName, courseLink, coursePrice, lectures, details, type } = req.body; // Add 'details' to destructuring
...
exports.updateCourse = async (req, res) => {
  ...
  const { id, courseName, courseLink, courseDescription, coursePrice, type } = req.body;
