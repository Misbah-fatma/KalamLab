                            ...
                            <CardContent>
                              ...
                              >
                                <CardMedia
                                  ...
                                  alt="Uploaded"
                                  sx={{
                                    maxHeight: { xs: '300px', sm: '400px', md: '500px' }, // Adjust max height for different screen sizes
                                    maxWidth: '100%',  // Ensure image width is responsive
                                    objectFit: 'contain', // Make sure the image fits without cropping
                                  }}
                                />
                              </Box>
                            </CardContent>
                          ...
                          <CardContent>
                            ...
                            {layerExplanations.map((layer, index) => (
                              <Box key={index} sx={{ mb: 3 }}>
                                ...
                                <Typography paragraph sx={{ textAlign: 'justify' }}>{layer.purpose}</Typography>
                                <Typography paragraph sx={{ textAlign: 'justify' }}>{layer.process}</Typography>
                              </Box>
                            ))}
                          </CardContent>
                        </Card>
...
// Layer explanation with justifications for text alignment
