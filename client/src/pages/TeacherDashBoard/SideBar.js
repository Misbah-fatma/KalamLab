...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
   ...
   <div className="option" onClick={() => toggleOptions('option1')}>
            ...
            <div className="option" onClick={() => toggleOptions('option7')}>
              <NavLink to="/liveClassteacher" activeClassName="active-link vertical-nav-menu">
              <i className="fa-solid fa-calendar-alt menu-icon"></i>
                Schedule Class
              </NavLink>
            </div>
            <div className="option" onClick={() => toggleOptions('option4')}>
          <NavLink to="/ChangeTeacherDetails" activeClassName="active-link vertical-nav-menu">
