...
const Dashboard3 = ({ course }) => {
  ...
  useEffect(() => {
    if (userId && courseData.length > 0) {
      const coursesCreatedByTeacher = courseData.filter(course => course.teacher._id === userId);
                  ...
                  <div className="card mb-3 widget-content bg-midnight-bloom">
                    <div className="widget-content-wrapper text-white">
                      <div className="widget-content-left">
                        ...
                        <div className="widget-subheading">Number of total courses</div>
                      </div>
                  ...
                  <div className="card mb-3 widget-content bg-arielle-smile">
                    <div className="widget-content-wrapper text-white">
                      <div className="widget-content-left">
                        ...
                        <div className="widget-subheading">Number of total enrollments</div>
                      </div>
